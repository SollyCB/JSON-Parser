...
static void print_parse_int(Print_Config *config, int64 i, int *buf_pos, char *print_buffer) {
    int max_zeros;
...
inline static void print_parse_unsigned_int(Print_Config *config, int64 i, int *buf_pos, char *print_buffer) {
